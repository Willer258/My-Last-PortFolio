...
const Skills = () => {
  ...
  return (
    ...
    <div className=" my-56 lg:w-5/6 mx-auto px-2 md:px-5 " id="skills">
      ...
      {
        view &&   <div className="mt-10 flex flex-col rounded-lg overflow-hidden">
       
   
        <div style={{gridTemplateColumns: `'repeat(${screens.length}, 1fr)'`}} className={`w-full gap-x-3 grid grid-cols-4 `}>
          {screens.map((screen, index) => (
            ...
            >
              <TypingAnimation className='text-lg font-semibold' text= {screen.name}/>
              <motion.div

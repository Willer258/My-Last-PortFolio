        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              {/* Gallery — full-bleed preview filling the panel surface (sticky on desktop) */}
              <div className="relative overflow-hidden bg-surface-dark group lg:sticky lg:top-0 h-[280px] sm:h-[400px] lg:h-[88vh]">

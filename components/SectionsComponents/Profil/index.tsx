  ...
  return (
    <div id="profil" className="lg:h-screen lg:w-5/6 mx-auto px-2 md:px-5">
      <div className="w-full border-b-2 border-black px-2 py-3 ">
        {" "}
        <h2 className="text-xl"> A propos de moi</h2>
      </div>
      <div className="flex flex-col font-medium lg:flex-row space-y-5 items-center lg:space-x-10  mt-10">
        <div className="space-y-3 lg:w-3/4 self-center">
          <p>
            Bonjour, Houinlindjonon Alain Wilfried développeur frontend a votre
            service.
          </p>
          <p>
            M'affirmer développeur et au niveau frontal m'incombe de respecter
            certains critères dont la conception, l'optimisation, l'amélioration
            et la maintenance de sites ou application (web ou mobile) de qualité
            tout en permettant la mécanique (API) destiné à ces derniers de
            fonctionner. J’en suis sûr au vu de tous mes challenges effectuer
            pendant mes travaux de respecter tous ces critères sans
            inconvénient.
          </p>
          <p>
